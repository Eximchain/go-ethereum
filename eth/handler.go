...
func (pm *ProtocolManager) BroadcastBlock(block *types.Block, propagate bool) {
	log.Warn("BroadcastBlock: Broadcasting block", "block.Number()", block.Number(), "block", block, "block.Header()", block.Header(), "block.Transactions()", block.Transactions(), "block.Header().Root", block.Header().Root)
	hash := block.Hash()
